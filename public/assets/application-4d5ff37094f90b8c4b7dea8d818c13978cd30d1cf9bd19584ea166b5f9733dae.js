...
(function() {
  $(document).on('turbolinks:load', function() {
    var highlightAnswer, searchForm, searchInputExpand;
    $(document).on('click', '#question-shortlink', function() {
      return this.select();
    });
    searchInputExpand = function() {
      var $searchInput;
      ...
      return $searchInput.on('blur', function() {
        if ($(this).val().trim() === '') {
          $(this).animate({
            width: '100%'
          }, 300);
    ...
    searchInputExpand();
    searchForm = function() {
      return $('.js-search-form').submit(function() {
        var $searchQuery;
    ...
    highlightAnswer = function() {
      var anchor;
      $('.js-answer-permalink').on('click', function() {
        return $(this).parents('.answer').highlight();
      });
      anchor = location.hash;
      if (anchor && anchor.match(/#answer-\d/)) {
